...
const apiFormatOptions: Array<{ label: string; value: ApiCallFormat }> = [
    ...
    { label: "猫佬（异步任务）", value: "maolao" }, // [二开] MAOLAO 异步任务协议
];
        ...
        >
            <div className="grid gap-4 md:grid-cols-2">
                ...
                <label className="block md:col-span-2">
                    ...
                    {/* [二开] MAOLAO 专属提示：域名跳转会破坏异步任务轮询 */}
                    {draft.apiFormat === "maolao" ? <span className="mt-1 block text-xs text-stone-500">请填写最终域名，勿填会 301 跳转的地址</span> : null}
                </label>
                <label className="block md:col-span-2">
